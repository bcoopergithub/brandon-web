...
const Layout = ({ children }) => {
    return (
        <>
                  <div style={{ backgroundImage: `url(${background_desktop})`,zIndex:'-1', backgroundAttachment: 'fixed' }} className="w-full h-full bg-no-repeat bg-cover bg-right invisible sm:visible  absolute"></div>
